...
package com.cdsoftware.requestprocessor.util;

import static com.cdsoftware.requestprocessor.test.util.RandomTestUtil.*;
import static com.cdsoftware.requestprocessor.test.util.ReflectionTestUtil.*;
...
class KeyValueLoggerTest {
	...
	void shouldPrintClassFromClass() {
		...
		verifyStringLog(Level.INFO, "class=\"com.cdsoftware.requestprocessor.util.KeyValueLogger\"");
	}
	...
	void shouldPrintPackageFromClass() {
		...
		verifyStringLog(Level.INFO, "package=\"com.cdsoftware.requestprocessor.util\"");
	}
